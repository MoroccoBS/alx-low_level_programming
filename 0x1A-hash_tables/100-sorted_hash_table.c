...
/**
 * add_n_shash - Adds a node on the DLL of the shash
 * @h: Pointer to the shash table
 * @key: key of the shash
 * @value: value of the shash
 * Return: the new shash
 */
...
/**
 * add_i_shash - Adds a node on the DLL of the shash
...
/**
 * shash_table_set - adds an element to the shash
 * @ht: pointer to the shash table
 * @key: key of the shash
...
/**
 * shash_table_print_rev - prints in reverse the keys and values
 * of the shash table
 * @ht: pointer to the shash table
 * Return: VOID
 */
...
/**
 * shash_table_delete - deletes a shash
 * @ht: pointer to the shash
 * Return: VOID
 */
